...
CXXFLAGS	:= $(CFLAGS)
CPPFLAGS	:= $(CFLAGS)
LDFLAGS		:= -L$(ROOTFS)/lib -L$(ROOTFS)/opt/vc/lib/ -L$(ROOTFS)/opt/vc/src/hello_pi/libs/ilclient -lGLESv2 -lEGL -lopenmaxil -lbcm_host -lvcos -lvchiq_arm -lilclient -lAndroidNativePlatform
